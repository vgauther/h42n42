...
let () = Js_of_ocaml.Firebug.console##log (Js_of_ocaml.Js.string "Creet: client module chargé")

let create (_global_speed : float ref) : creet =
  Js_of_ocaml.Firebug.console##log (Js_of_ocaml.Js.string "Creet.create appelé");
